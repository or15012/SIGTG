...
!function() {
/*!******************************************!*\
  !*** ./resources/js/group_initialize.js ***!
  \******************************************/
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (response.success) {
          ...
          students.push(user);
          var stringHtml = "\n                        <div class=\"col-12 col-md-6 col-lg-6 \">\n                            <div class=\"card mb-4\">\n                                <div class=\"card-header\">\n                                    ".concat(user.carnet, " - ").concat(user.first_name, " ").concat(user.middle_name, " ").concat(user.last_name, " ").concat(user.second_last_name, "\n                                </div>\n                                <div class=\"card-body\">\n\n                                    <input type=\"hidden\" name=\"users[]\" value=\"").concat(user.id, " \">\n                                    <div>\n                                        <label class=\"my-1 fw-bold\">Estado de asignaci\xF3n</label>\n                                    </div>\n                                    <div>\n                                        <label class=\"my-1 bg-soft-secondary text-opacity-100 p-2 rounded\">\n                                            Pendiente de env\xEDo.\n                                        </label>\n                                    </div>\n                                    <button type=\"button\" data-user=\"").concat(user.id, "\" class=\"delete-user btn btn-danger waves-effect waves-light\">\n                                        <i class=\"fas fa-window-close\"></i>\n                                    </button>\n                                </div>\n                            </div>\n                        </div>");
