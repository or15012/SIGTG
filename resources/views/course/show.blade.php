...
@section('content')
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            -->
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="suscriptions-tab" data-bs-toggle="tab" data-bs-target="#suscriptions-tab-pane" type="button" role="tab" aria-controls="suscriptions-tab-pane" aria-selected="false">Inscripciones <small>({{count($course->registrations)}})</small></button>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent">
            ...
            -->
            <div class="tab-pane fade show active" id="suscriptions-tab-pane" role="tabpanel" aria-labelledby="suscriptions-tab" tabindex="0">
                <div class="mt-3">
                    <table class="table">
                        <thead>
                            <tr>
